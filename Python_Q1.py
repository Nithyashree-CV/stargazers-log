...
# Follow the TODO comments in both files for step-by-step instructions. The comments will guide
# you through creating the class with proper variables, methods, and showing how class variables
